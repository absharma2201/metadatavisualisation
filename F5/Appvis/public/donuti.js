function Donut(d3, appGroupsUtil) {
    'use strict';
    ...
    function groupData(data) {
        ...
        gnestedData.forEach(function (d) {
            var group = {groupname: d.key, bytesc: 0};
    ...
    Donut.prototype.drawChart = function (tdata, data_divisor, ucallback) {
    ...
    Donut.prototype.updateChart = function (ldata, hdata) {
        var dataset;
        if (mode == MODE_LIVE) {
            dataset = ldata;
        } else {
